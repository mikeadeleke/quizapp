function MikeAdeleke() {
  ...
  var q8 = {
    question: "What is he learning now outside of Front-end and Ruby on Rails?",
...
$(document).ready(function() {
  var quizName = new MikeAdeleke();

  var click = $("#button").on("click", function {
    alert("Oh hai there!");
  });
